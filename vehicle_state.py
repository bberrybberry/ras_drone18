...
print(" Read vehicle param 'heading': %s" % vehicle.parameters['COMPASS_USE'])

# print(" Write vehicle param 'heading' : 10")
# vehicle.parameters['heading']=10
# print(" Read new value of param 'heading': %s" % vehicle.parameters[attr_key])
...
@vehicle.parameters.on_attribute('heading')  
